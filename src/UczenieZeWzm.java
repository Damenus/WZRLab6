...
public class UczenieZeWzm {
    ...
    double alfa = 0.04;               // szybkosc uczenia ............................. TO NALEŻY USTAWIĆ (może być funkcją w zależności od nru epizodu)
    double epsylon = 0.25;            // wspolczynnik eksploracji podczas uczenia ..... TO NALEŻY USTAWIĆ (może być funkcją w zależności od nru epizodu)


    double gamma = 0.97;              // wspolczynnik dyskontowania (1-wszystkie nagrody i kary tak samo ważne, jeśli < 1 to bliższe ważniejsze)
    float Q[][][];                    // tablica przybliżonych użyteczności akcji (po stanach agenta (wiersz, kolumna) i akcjach), inaczej orzybliżona
                                      // średnia suma nagród jaką można zdobyć od wykonania akcji do końca epizodu przy założonej strategii
    ...
    {
        System.out.println("Uczenie ze wzmocnieniem Q-learning - wersja h");
