...
// ----------------------------------------
   int dlugosc_pauzy = 112;  // długość przerwy w animacji w [ms]
   ...
   int liczba_agentow = 1;                               // liczba wszystkich agentow (pozniej sie moze zmienic)
...
// ------------------------
	...
	if (msg2!=null)
        ...
        //myGui.UstawGabarytyPlanszy(liczba_wierszy, liczba_kolumn);
	    ...
	    public void action() {
                ...
                if (met_uczenia == UCZENIE_ZE_WZMOCNIENIEM)
                {
                    if (uzw.numer_epizodu < maks_liczba_epizodow)
                    {
                        ...
                        if (System.currentTimeMillis()-czas < 2017)
                        {
	    ...
	    public void action() {
                ...
                if (msg!=null)
                {
                    ...
                    try{
                        ...
                        System.out.println( "Nie udało się zupełnie odserializować! "+e);
                        e.printStackTrace();
                    }
                    ...
                    if (numer_agenta == moj_numer) // odebrano nasz własny stan
                    {
                        ...
                        String tekst = new String(": Nowy stan = ("+moj_stan.w+","+moj_stan.k+") nagroda = "+
                                moj_stan.nagroda+ " pieniądze = " + moje_konto);
